...
def test_parse_model_variables_levels_mapping():
    ...
    assert to_test == {'air_temperature_2m': 'single-level',
                       ...
                       'temperature': 'model-level', 'wind_u': 'model-level',
                       'wind_v': 'model-level',
...
def test_parse_model_variables_mapping():
    ...
    assert to_test == {'albedo': 'alb_rad', 'air_temperature_2m': 't_2m',
                       ...
                       'weather_synop_code': 'ww', 'soil_temperature': 't_g',
                       'total_cloud_cover': 'clct',
                       'relative_humidity_2m': 'relhum_2m', 'temperature': 't',
                       'wind_u': 'u', 'wind_v': 'v',
                       'geopotential_height': 'fi',
                       'snowfall_height': 'snowlmt',
                       'relative_humidity': 'relhum', 'pressure_surface': 'ps',
