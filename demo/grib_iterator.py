...
from eccodes import codes_grib_new_from_file, codes_set, codes_grib_iterator_new, codes_grib_iterator_next, \
    codes_grib_iterator_delete, codes_release, CodesInternalError
